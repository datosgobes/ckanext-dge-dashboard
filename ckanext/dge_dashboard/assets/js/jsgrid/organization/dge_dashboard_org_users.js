...
ckan.module('dge_dashboard_org_users', function ($, _) {
  return {
    initialize: function () {
      var ou_data_provider = this.options.data_provider;
      jsGrid.locale(this.options.language);
      var ou_grid = new jsGrid.Grid($("#" + this.options.divid), {
        fields: [
          { 
            name: "username", 
            type: "string", 
