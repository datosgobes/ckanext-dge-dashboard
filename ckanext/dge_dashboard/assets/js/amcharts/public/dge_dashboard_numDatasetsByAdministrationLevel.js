...
ckan.module('dge_dashboard_numDatasetsByAdministrationLevel', function ($, _) {
  return {
    initialize: function () {
      var chart_ndbal = AmCharts.makeChart(this.options.divid, {
        "type": "pie",
        "theme": "light",
        ...
        "valueField": "num_datasets",
        "titleField": "administration_level",
        "export": {"enabled": true}, 
