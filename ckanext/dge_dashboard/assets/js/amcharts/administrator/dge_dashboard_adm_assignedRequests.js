...
ckan.module('dge_dashboard_adm_assignedRequests', function ($, _) {
  return {
    initialize: function () {
      var chart_aar = AmCharts.makeChart(this.options.divid, {
        "type": "pie",
        "startDuration": 0,
        "theme": "light",
      ...
      chart_aar.addListener("rollOverSlice", function(e) {
        handleRollOver(e);
      });
