...
ckan.module('dge_dashboard_adm_numUsersByAdministrationLevel', function ($, _) {
  return {
    initialize: function () {
      var chart_anubal = AmCharts.makeChart(this.options.divid, {
        "type": "pie",
        "theme": "light",
        ...
        "valueField": "num_users",
        "titleField": "adm_level",
        "export": {"enabled": true}, 
