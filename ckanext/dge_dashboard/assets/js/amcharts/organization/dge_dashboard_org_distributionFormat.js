...
ckan.module('dge_dashboard_org_distributionFormat', function ($, _) {
  return {
    initialize: function () {
      var chart_odf = AmCharts.makeChart(this.options.divid, {
        "type": "pie",
        "startDuration": 0,
        "theme": "light",
      ...
      chart_odf.addListener("rollOverSlice", function(e) {
        handleRollOver(e);
      });
